//
//  MappableSleepDesaturation.swift
//  SOLTEC•Z
//
...
struct MappableSleepDesaturation: Mappable {

    typealias StorableType = CoreSleepDesaturation
    typealias DomainType = SleepDesaturation
